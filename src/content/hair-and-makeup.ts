...
export const hairAndMakeup: SeoArticle = {
  ...
  breadcrumbs: [
    ...
    { name: "Hair & Makeup", path: "/services/hair-and-makeup" },
  ],
  serveAreas: [
  ...
  body: [
    ...
    {
      type: "p",
      text: "The studio sits at 5530 Joyce Street in South Renfrew-Collingwood, East Vancouver. There is a dedicated makeup station, ring light, mirrors, air conditioning, and natural light when you want to see how makeup reads on camera. Vancouver photographers send clients here because the address is easy, parking is sane, and trials happen in the same room where many bridal portraits are taken afterward.",
    },
    {
      type: "h2",
    ...
    {
      type: "p",
      text: "During the trial Michelle takes written notes and reference photos: foundation shade, contour placement, lip colour, curl pattern, pin placement, timing estimates. Those notes live at the studio for wedding day. When you sit down on the morning of your wedding, the conversation starts from saved detail instead of from scratch in a hotel bathroom mirror.",
    },
    {
      type: "h3",
      text: "What to bring to a trial",
    },
    {
      type: "p",
      text: "Bring photos of looks you like, photos of looks you do not like, your dress neckline photo if the dress is not ready yet, and any skin sensitivities upfront. If you already booked [wedding photography](/services/wedding-photography) with Michelle, mention photo timing so glam finishes before portraits. If your photographer is someone else, tell us their arrival time so nobody is waiting with a wet curl.",
    },
    {
      type: "h2",
      text: "Wedding-day hair and makeup",
    },
    {
      type: "p",
    ...
    {
      type: "h2",
      text: "Session glam for portraits and boudoir",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "Session glam is usually lighter than stage makeup but more polished than everyday product. If you prefer doing your own base and need eyes and lips only, say so. If you want full face and hair styled, book enough time. Combining glam with photos in one stop is why the makeup station lives inside a photography studio instead of a salon across town.",
    },
    {
      type: "table",
      caption: "Hair & makeup appointment types",
      headers: ["Appointment", "When", "Purpose"],
      rows: [
        [
          "Bridal trial",
          "Weeks before the wedding",
          "Test look; notes and reference photos saved",
        ],
        [
          "Wedding-day glam",
          "Morning of",
          "Repeat trial look; bridesmaids optional",
        ],
        [
          "Session glam",
          "Before portraits or boudoir",
          "Camera-ready makeup and hair styling",
        ],
        [
          "Trial + portraits",
          "Same day if timed",
          "Approve makeup and photograph in one visit",
        ],
      ],
    },
    {
      type: "h2",
      text: "How trials connect to photography",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "Photographers who refer clients here appreciate that trials produce reference photos they can skim before wedding day. Everyone is looking at the same lip colour instead of guessing from a phone screenshot taken in a car.",
    },
    {
      type: "h2",
    ...
    },
    {
      type: "ol",
      items: [
        "Book the trial before finalizing wedding-day timing with your planner",
        "Send inspiration photos at least a few days ahead if you can",
    ...
    {
      type: "h2",
      text: "Location, parking, and hours",
    },
    {
      type: "p",
    ...
    },
    {
      type: "ul",
      items: [
        "Trials include notes and reference photos kept for wedding day",
    ...
    {
      type: "h2",
      text: "When to book hair and makeup without photography",
    },
    {
      type: "p",
  ...
  faqs: [
    {
      id: "hmu-trial-why",
      question: "Why should I book a bridal hair and makeup trial?",
      answer:
        "Trials test your look before the wedding, with time to adjust. Michelle saves notes and reference photos so wedding-day glam matches what you approved.",
    },
    {
      id: "hmu-trial-when",
    ...
    {
      id: "hmu-session",
      question: "Can I book makeup for a portrait or boudoir session?",
      answer:
        "Yes. Session glam is available for headshots, branding, boudoir, and other studio sessions. Book enough time before photos begin.",
    },
    {
      id: "hmu-bridesmaids",
      question: "Can bridesmaids and family get hair and makeup too?",
      answer:
        "Yes. Share headcounts and who needs what when booking so the morning timeline fits everyone without rushing the bride.",
    },
    {
      id: "hmu-photos-trial",
      question: "What are reference photos from a trial?",
      answer:
        "Michelle photographs the finished trial look and keeps notes on products and placement. Those references guide wedding-day consistency.",
    },
    {
      id: "hmu-own-makeup",
    ...
    {
      id: "hmu-book",
      question: "How do I book a trial or wedding-day glam?",
      answer:
        "Email hello@ninhstudio.ca, call (778) 908-4160, or use the contact form. Include your wedding date, party size, and whether you need a trial.",
    },
  ],
};
