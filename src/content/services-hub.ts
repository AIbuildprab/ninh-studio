...
export const servicesHub: SeoArticle = {
  ...
  body: [
    {
      type: "p",
      text: "People searching for photography services in Vancouver are usually trying to do two things at once: find someone they trust in front of the camera, and find a room that will not fight them. This page is the map of what Ninh Studio actually does at 5530 Joyce Street — portraits, weddings, hair and makeup, baby and boudoir sessions, commercial and event work, and hourly studio rental — so you can pick a path without guessing from a homepage carousel.",
    },
    {
      type: "p",
      text: "Michelle opened the studio in South Renfrew-Collingwood because she wanted sessions to feel slower. Cameras make a lot of people nervous. Hair and makeup happen in the same room. The Expo Line stop at Joyce-Collingwood is about a 650 metre walk, which matters if you are coming from [Burnaby](/areas-we-serve/burnaby), [downtown](/areas-we-serve/downtown-vancouver), or [New Westminster](/areas-we-serve/new-westminster) after work.",
    },
    {
      type: "h2",
    ...
    {
      type: "p",
      text: "Think of Ninh Studio as one address with a few distinct jobs. Some clients want photographs. Some want hair and makeup. Some already have a photographer and only need the room. All of that is legitimate, and the pages below treat each job as its own topic instead of stuffing every keyword into one paragraph.",
    },
    {
      type: "table",
      ...
      rows: [
        [
          ...
          "1–2 hours in studio, direction included",
        ],
        [
          "A wedding day",
    ...
    {
      type: "h2",
      text: "The local scene, without the brochure voice",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "If you live in [East Vancouver](/areas-we-serve/east-vancouver), this is a neighbourhood studio, not a destination warehouse in an industrial park. If you do not, the Expo Line is the honest reason the location works: one train, a short walk, no Gastown loading-zone theatre.",
    },
    {
      type: "h2",
    ...
    },
    {
      ...
      items: [
        ...
        "Any SkyTrain / parking constraint (we will tell you the 650 m walk is real)",
      ],
    },
    {
      type: "h2",
    ...
    {
      type: "p",
      text: "It is not a fake menu of 40 cities. Ninh Studio is one studio, one phone number — (778) 908-4160 — and a set of neighbourhoods people actually travel from. Hours are Tuesday to Saturday 9:30–5:30 and Sunday 10:00–5:30. Monday is closed. Appointments only.",
    },
  ],
  faqs: [
    {
