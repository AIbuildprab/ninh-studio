...
export const weddingPhotography: SeoArticle = {
  ...
  image: {
    ...
    alt: "Cherry blossom bridal portrait at Ninh Studio, East Vancouver wedding photography",
  ...
  body: [
    ...
    {
      type: "h2",
      text: "What wedding coverage can include",
    },
    {
      type: "p",
    ...
    {
      type: "h3",
      text: "Getting ready at the studio",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "Couples who live in East Vancouver or Burnaby often choose the studio because parking is straightforward: two free on-site spots, street parking nearby, and Joyce-Collingwood SkyTrain about 650 metres away. If your wedding party is arriving from [downtown Vancouver](/areas-we-serve/downtown-vancouver), the Expo Line to Joyce-Collingwood is usually simpler than coordinating rideshares in Gastown loading zones.",
    },
    {
      type: "h3",
      text: "Ceremony and reception on location",
    },
    {
      type: "p",
    ...
    {
      type: "h3",
      text: "Last dance and late reception light",
    },
    {
      type: "p",
    ...
    {
      type: "h2",
      text: "Bridal portraits before the guests arrive",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "A pre-wedding portrait hour is also useful when your ceremony is small and fast. You still get formal images without carving an hour out of cocktail hour. Michelle helps with veil, train, and bouquet handling so you are not wrestling fabric alone.",
    },
    {
      type: "h2",
      text: "Hair, makeup, and photography under one roof",
    },
    {
      type: "p",
    ...
    {
      type: "table",
      caption: "Common wedding-day shapes",
      headers: ["What you need", "Where it often happens", "Notes"],
      rows: [
        [
          "Bridal trial + notes",
          "Ninh Studio, Joyce Street",
          "Weeks before the wedding; reference photos kept on file",
        ],
        [
          "Getting ready + glam",
          "Studio makeup station",
          "Same building as quiet bridal portraits",
        ],
        [
          "Ceremony",
          "Your venue",
          "Travel included in day-of coverage quote",
        ],
        [
          "Couple portraits",
          "Studio, park, or venue grounds",
          "Weather and timeline decide",
        ],
        [
          "Reception through last dance",
          "Your reception site",
          "Low light handled in-room",
        ],
      ],
    },
    {
      type: "h2",
      text: "How Michelle works on a wedding day",
    },
    {
      type: "p",
    ...
    {
      type: "h2",
      text: "Who this is a good fit for",
    },
    {
      type: "p",
    ...
    {
      type: "h2",
      text: "Pricing, deliverables, and booking lead time",
    },
    {
      type: "p",
    ...
    {
      type: "h2",
      text: "Practical details for your wedding party",
    },
    {
      type: "ul",
      items: [
  ...
  faqs: [
    ...
    },
    {
      ...
      question: "Can we get ready at Ninh Studio on the wedding morning?",
      answer:
    ...
    {
      id: "wedding-makeup-only",
      question: "We have a photographer already. Can we book only hair and makeup?",
      answer:
