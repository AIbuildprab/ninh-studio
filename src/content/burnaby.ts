...
export const burnaby: SeoArticle = {
  slug: "burnaby",
  kind: "area",
  ...
  image: {
    ...
    alt: "Professional headshot session at Ninh Studio, easy reach from Burnaby via SkyTrain",
    objectPosition: site.serviceImages.headshots.objectPosition,
  },
  breadcrumbs: [
    { name: "Home", path: "/" },
    { name: "Areas we serve", path: "/areas-we-serve" },
    { name: "Burnaby", path: "/areas-we-serve/burnaby" },
  ],
  offerServices: [
  ...
  body: [
    ...
    {
      type: "h2",
      text: "Why Burnaby clients come west to Joyce Street",
    },
    {
      type: "p",
    ...
    {
      type: "h2",
      text: "Getting here from Metrotown and central Burnaby",
    },
    {
      type: "table",
    ...
    {
      type: "h2",
      text: "Landmarks Burnaby clients know on the way",
    },
    {
      type: "p",
    ...
    {
      type: "h2",
      text: "What Burnaby clients book",
    },
    {
      type: "h3",
      text: "Headshots and corporate portraits",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "Couples from Burnaby book wedding-day coverage and also use Joyce Street for getting-ready photography, bridal portraits, or hair and makeup trials. Michelle keeps trial notes so the wedding-day look repeats reliably. If you already hired a photographer, bridal hair and makeup alone is still a common Burnaby booking.",
    },
    {
      type: "h3",
      text: "Studio rental for Burnaby photographers",
    },
    {
      type: "p",
    ...
    {
      type: "h2",
      text: "Metrotown professionals and Boundary families",
    },
    {
      type: "p",
    ...
    {
      type: "h2",
      text: "Driving vs SkyTrain from Burnaby",
    },
    {
      type: "p",
    ...
    {
      type: "h2",
      text: "Checklist for Burnaby clients",
    },
    {
      type: "ul",
      items: [
    ...
    {
      type: "h2",
      text: "What the 597-square-foot room includes",
    },
    {
      type: "p",
    ...
    {
      type: "h2",
      text: "One address, many Burnaby regulars",
    },
    {
      type: "p",
  ...
  faqs: [
    ...
    {
      id: "by-rental",
      question: "Can Burnaby photographers rent the studio?",
      answer:
        "Yes. C$60/hour including tax, two-hour minimum, lights and backdrops included. Tagvenue booking or direct inquiry.",
    },
    {
      id: "by-parking",
      question: "Where do I park if I drive from Burnaby?",
      answer:
        "Two free on-site spots when available, plus street parking on Joyce and nearby side streets.",
    },
    {
      id: "by-wedding",
      question: "Do you photograph Burnaby weddings?",
      answer:
        "Yes. Wedding photography is quoted for the day. Burnaby couples often book getting-ready or bridal portraits at the studio before the ceremony.",
    },
    {
      id: "by-headshot",
    ...
    {
      id: "by-hmu",
      question: "Is bridal hair and makeup available?",
      answer:
        "Yes. Trials and wedding-day hair & makeup happen on Joyce Street, with or without photography booked.",
    },
    {
      id: "by-size",
      question: "How large is the studio?",
      answer: "597 square feet, capacity up to 20 for rental, smaller for directed portrait sessions.",
    },
    {
      id: "by-book",
      question: "How do Burnaby clients book?",
      answer:
