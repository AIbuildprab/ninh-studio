...
export const newWestminster: SeoArticle = {
  ...
  body: [
    {
      type: "p",
      text: "New Westminster sits on the Fraser, with Columbia Street, the Quay, and New Westminster Station anchoring a city that feels both historic and commutable. Ninh Studio is not in New Westminster — we are at 5530 Joyce Street, Vancouver BC V5R 4H6, in Collingwood — and we will say that clearly. What we share with New West clients is the Expo Line: board westbound at New Westminster Station, ride to Joyce-Collingwood, walk about 650 metres south on Joyce Street, and you are at the studio door. For portraits, weddings, baby sessions, and hourly studio rental, that trip is often simpler than driving to a downtown Vancouver address and hunting for parking.",
    },
    {
      type: "p",
      text: "People search for a photography studio New Westminster residents can trust without crossing three municipalities blindly. Michelle runs one room — 597 square feet, air conditioned, with a makeup station and professional lights already in place. [Portrait photography](/services/portrait-photography) for families and professionals, [wedding photography](/services/wedding-photography) quoted for the day, and [baby photography](/services/baby-photography) paced around naps and feeds. New West parents, couples planning weddings at the Quay or in Burnaby, and SkyTrain commuters book here because the Expo Line makes Joyce Street reachable without a car.",
    },
    {
      type: "h2",
    ...
    {
      type: "p",
      text: "New Westminster has riverfront charm and growing density along Columbia and Sixth. It does not have as many small private photo studios with on-site parking, in-room hair and makeup, and a photographer who blocks unhurried time for nervous subjects. Families in Queensborough and Sapperton book baby milestones because the studio is warm and private — not a mall backdrop with a line behind you. Couples book bridal portraits before a ceremony at a New West hall or a Burnaby venue. Professionals SkyTrain after work for headshots because the math beats bridge traffic to Gastown.",
    },
    {
      type: "p",
      text: "We prove local relevance through transit and honesty, not fake addresses. There is no Ninh Studio on Columbia Street. There is one phone number — (778) 908-4160 — and one Joyce Street door.",
    },
    {
      type: "h2",
    ...
    },
    {
      ...
      headers: ["Origin", "Route", "Honest door-to-door"],
      rows: [
        [
        ...
        [
          ...
          "~20–35 min depending on mode",
        ],
        [
          "Driving direct",
          "Kingsway east toward Joyce Street",
          "~15–25 min off-peak + easy street parking",
        ],
      ],
    },
    {
    ...
    {
      type: "p",
      text: "On the New Westminster side, Columbia Street, the waterfront, and the SkyTrain platform at New Westminster Station are the familiar anchors. On the Joyce Street side, Joyce-Collingwood Station, Kingsway one block north, and the Collingwood neighbourhood shops line the walk to 5530 Joyce. The studio sits in the kind of East Vancouver strip where people buy groceries and coffee, not tourist postcards — which suits clients who want a session, not a sightseeing detour.",
    },
    {
      type: "h2",
    ...
    {
      type: "p",
      text: "New Westminster families often choose in-studio baby photography because the room is controlled — warm, quiet, with breaks for feeding. Siblings can move without a public audience. Sessions follow the baby’s pace rather than a rigid twenty-minute slot.",
    },
    {
      type: "h3",
    ...
    {
      type: "p",
      text: "SkyTrain is predictable: westbound Expo Line to Joyce-Collingwood, exit, walk south on Joyce about seven to ten minutes. Driving via Kingsway off-peak is often fifteen to twenty-five minutes with straightforward parking — two free on-site spots when available, plus street parking on Joyce. Rush hour can stretch either mode; we suggest padding time or choosing the train when Columbia Street traffic is heavy. We will not promise “five minutes away.” We will tell you what other New West clients actually plan.",
    },
    {
      type: "h2",
    ...
    },
    {
      ...
      items: [
        ...
        "From New Westminster Station: Expo Line westbound to Joyce-Collingwood, walk ~650 m",
    ...
    {
      type: "p",
      text: "Studio hours are Tuesday through Saturday 9:30 AM to 5:30 PM and Sunday 10:00 AM to 5:30 PM. Monday is closed. Appointments only — walk-ins are not possible because Michelle may be mid-session. New Westminster clients often book Sunday baby sessions or weekday headshots when SkyTrain frequency is good and Columbia Street traffic is lighter. Wedding inquiries should mention date, venue, and whether you need full coverage or studio time only so the quote matches the job.",
    },
    {
      type: "h2",
    ...
    {
      type: "p",
      text: "Ninh Studio serves New Westminster clients without pretending to be there. The relationship is the train line, the walk, and the work — portraits, weddings, babies, rental — done calmly in a 597-square-foot room on Joyce Street. If you live along the Fraser or commute through New Westminster Station, Joyce-Collingwood is a few stops west. Michelle will meet you at the door, not at a fictional Columbia Street suite.",
    },
  ],
  faqs: [
    {
    ...
    },
    {
      ...
      answer:
        "Typically twenty-five to thirty-five minutes door-to-door: Expo Line westbound to Joyce-Collingwood plus a 7–10 minute walk on Joyce Street.",
    },
    {
      id: "nw-fake",
